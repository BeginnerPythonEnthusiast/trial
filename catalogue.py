...
def video_page(video):
    print (video)
    url = 'http://34.140.72.240/myflix/videos?filter={"video.uuid":"'+video+'"}'
    headers = {}
    payload = json.dumps({ })
...
@app.route('/')
def cat_page():
    url = "http://34.140.72.240/myflix/videos"
    headers = {}
    payload = json.dumps({ })
    ...
    for index in jResp:
       ...
       for key in index:
           ...
           if (key !="_id"):
              ...
              html=html+'<img src="https://storage.googleapis.com/mybucket_1111/myflix/pictures/'+thumb+'"height =380px width =280px >'
              html=html+"</a>"        
              print("=======================")
